...
df_apps_4NICs_LACP <- read_csv("/home/mrneverdie/Git/NEWP/RESULTS/802.3ad-4NICs-layer2-4/LOGS/FT-FT-64.csv", progress=FALSE)
data.frame(conc="LACP_4", df_apps_4NICs_LACP) -> df_apps_4NICs_LACP
df_apps_4NICs_LACP$apps=toupper(df_apps_4NICs_LACP$apps)

df_apps_2NICs_LACP <- read_csv("/home/mrneverdie/Git/NEWP/RESULTS/802.3ad-2NICs-layer2-4/LOGS/FT-FT-64.csv", progress=FALSE)
data.frame(conc="LACP_2", df_apps_2NICs_LACP) -> df_apps_2NICs_LACP
df_apps_2NICs_LACP$apps=toupper(df_apps_2NICs_LACP$apps)

df_apps_native <- read_csv("/home/mrneverdie/Git/NEWP/RESULTS/native-4instanc/LOGS/FT-FT-64.csv", progress=FALSE)
data.frame(conc="Native",  df_apps_native) ->  df_apps_native
df_apps_native$apps=toupper( df_apps_native$apps)

df_apps_2NICs_RR <- read_csv("/home/mrneverdie/Git/NEWP/RESULTS/rr-2NICs-layer2-4/LOGS/FT-FT-64.csv", progress=FALSE)
data.frame(conc="RR_2", df_apps_2NICs_RR) -> df_apps_2NICs_RR
df_apps_2NICs_RR$apps=toupper(df_apps_2NICs_RR$apps)

df_apps_4NICs_RR <- read_csv("/home/mrneverdie/Git/NEWP/RESULTS/rr-4NICs-layer2-4/LOGS/FT-FT-64.csv", progress=FALSE)
