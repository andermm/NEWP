...
SSH_CONNECTION=127.0.0.1 48594 127.0.1.1 22
LANG=en_US.UTF-8
XDG_SESSION_ID=5591
USER=lacp
PWD=/home/lacp
HOME=/home/lacp
SSH_CLIENT=127.0.0.1 48594 22
MAIL=/var/mail/lacp
SHELL=/bin/bash
SHLVL=2
LOGNAME=lacp
   ...
   MCA rmaps round_robin: parameter "rmaps_round_robin_priority" (current value: "10", data source: default, level: 9 dev/all, type: int)
     ...
     MCA rmaps resilient: parameter "rmaps_resilient_fault_grp_file" (current value: "", data source: default, level: 9 dev/all, type: string)
       ...
       MCA ompi hostname: parameter "ompi_hostname_cutoff" (current value: "4294967295", data source: default, level: 9 dev/all, type: unsigned_int, deprecated, synonym of: orte_direct_modex_cutoff)
          ...
          MCA coll tuned: informational "coll_tuned_allreduce_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_alltoall_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_allgather_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_allgatherv_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_alltoallv_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_barrier_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_bcast_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_reduce_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_reduce_scatter_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_gather_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
          ...
          MCA coll tuned: informational "coll_tuned_scatter_algorithm_count" (current value: "21966", data source: default, level: 5 tuner/detail, type: int)
